...
import logo from "../images/littlefont1.png";
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col l5 s12 pt-5">
            <img
              src={logo}
              className="responsive-img mt-4 logobottom"
              alt="logo"
              width="100%"
              height="100%"
            />
          ...
          <div className="col l7 s12">
            <h5 className="name green-text nametext">
              Little Earth Farms & Nursery
            </h5>
            <p>
              Little Earth Farms and Nursery is a leading commercial landscaping
              / Horticulture and maintenance company. For Five years the company
              has maintained its commitment to quality, integrity and service.
              We believe that your garden can give you more happiness than any
              other possessions would ever do. It gives immense pride in helping
              Mother nature in ways of our business, we are driven by that very
              passion and love.Truly effective Horticulture management requires
              the ability to deliver a complete range of services. Our services
              combine intelligent cost control and multi-layer problem solving
              into a complete landscape management solution.{" "}
            </p>
          </div>
        </div>
      </div>
